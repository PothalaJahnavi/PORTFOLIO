...
const Skills = () => {
  const skills = [{ title: "HTML" }, { title: "CSS" }, { title: "Nodejs" }, { title: "JAVASCRIPT" }, { title: "C LANGUAGE" }, { title: "C++" }, { title: "PYTHON" }, { title: "REACTJS" }, { title: "NODEJS" }, { title: "EXPRESSJS" }, { title: "MONGODB" }, { title: "Angular" }, { title: "PUBLIC SPEAKING" }, { title: "TEAMWORK" }, { title: "LEADERSHIP" }]

  useEffect(() => {
    console.log('Loading TagCanvas...');
    const TagCanvas = window.TagCanvas;
    const tagCanvasOptions = {
      textColour: 'rgb(156, 157, 159)',
